...
const maxSessionBytes int64 = 256 << 20

// Access optionally wraps filesystem operations. Android uses the app's own
// private directory and leaves this pure-module hook unset.
